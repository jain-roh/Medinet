...
try {
    ...
    PreparedStatement s1=con.prepareStatement("insert into tblproduct_admin (p_disease,p_name,p_dosage,p_side,p_age) values ('"+p_disease+"','"+p_name+"','"+p_dosage+"','"+p_side+"','"+p_age+"')");
s1.executeUpdate();
